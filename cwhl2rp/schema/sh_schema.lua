...
Clockwork.animation:AddCombineOverwatchModel("models/kz2/helghast2.mdl");


Clockwork.animation:AddCombineOverwatchModel("models/kz2/helghast_am.mdl");


Clockwork.animation:AddCombineOverwatchModel("models/kz2/helghast_rif.mdl");


Clockwork.animation:AddCombineOverwatchModel("models/kz2/helghast_smg.mdl");
...
Clockwork.option:SetKey("intro_background_url", "http://i.imgur.com/guCPUjw.jpg");
Clockwork.option:SetKey("intro_logo_url", "https://steamuserimages-a.akamaihd.net/ugc/580197730019863916/2027C2D7E970BFA915B53A9745250250637C28BD/");
...
Clockwork.quiz:AddQuestion("Are you a minge?", 1, "No", "Yes.");
...
Clockwork.quiz:AddQuestion("What universe is this roleplaying game set in?", 2, "Real Life.", "Shell Shock");
